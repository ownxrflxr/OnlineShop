...
export function isRegexpSuccessCriteria(criteria) {
    return criteria.type === 'regex';
}
export function isJSONPathSuccessCriteria(criteria) {
...
export function validateSuccessCriteria(successCriteria) {
    successCriteria.forEach((criteria) => {
        ...
        if (isRegexpSuccessCriteria(criteria)) {
            ...
            const invalidKeys = matches.filter((key) => !ALLOWED_EXPRESSION_KEYS.includes(key));
