...
export declare function resolveXSecurityParameters({ ctx, runtimeContext, step, operation, workflowLevelXSecurityParameters, }: {
    ctx: TestContext;
...
//# sourceMappingURL=resolve-x-security-parameters.d.ts.map