...
export class ApiFetcher {
    ...
    initVerboseResponseLogs = ({ headerParams, host, path, method, body, statusCode, responseTime, responseSize, }) => {
    ...
    fetchResult = async ({ ctx, step, requestData, workflowId, }) => {
