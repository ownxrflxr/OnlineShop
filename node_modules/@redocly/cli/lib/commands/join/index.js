import { BaseResolver, formatProblems, getTotals, detectSpec, bundleDocument, logger, isPlainObject, isEmptyObject, getTypes, } from '@redocly/openapi-core';
import { blue, yellow } from 'colorette';
import * as path from 'node:path';
import { performance } from 'node:perf_hooks';
import { exitWithError } from '../../utils/error.js';
import { getFallbackApisOrExit, printExecutionTime, sortTopLevelKeys, getAndValidateFileExtension, writeToFileByExtension, } from '../../utils/miscellaneous.js';
import { COMPONENTS } from '../split/constants.js';
import { replace$Refs, getInfoPrefix, getApiFilename, iteratePotentialConflicts, populateTags, collectExternalDocs, collectPaths, collectComponents, collectWebhooks, addInfoSectionAndSpecVersion, } from './utils/index.js';
