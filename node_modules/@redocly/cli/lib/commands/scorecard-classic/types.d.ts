...
export type ScorecardClassicOutputFormat = Extract<OutputFormat, 'stylish' | 'json' | 'checkstyle'> | 'junit';
...
export type ScorecardProblem = NormalizedProblem & {
...
export type Project = {
    ...
    config: ResolvedConfig & {
        pluginsUrl?: string;
        scorecardClassic?: ScorecardConfig;
    };
};
