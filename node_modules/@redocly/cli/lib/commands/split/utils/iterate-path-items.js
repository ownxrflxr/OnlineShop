...
import { pathToFilename, escapeLanguageName, langToExt, writeToFileByExtension, } from '../../../utils/miscellaneous.js';
...
export function iteratePathItems(pathItems, openapiDir, outDir, componentsFiles, pathSeparator, codeSamplesPathPrefix = '', ext) {
    if (!pathItems)
        return;
...
//# sourceMappingURL=iterate-path-items.js.map