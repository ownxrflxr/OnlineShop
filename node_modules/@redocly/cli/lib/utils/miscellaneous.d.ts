import { type Config, type Oas3Definition, type Oas2Definition, type Exact, type Async3Definition, type Async2Definition } from '@redocly/openapi-core';
import { type Totals, type Entrypoint, type OutputExtension, type CommandArgv } from '../types.js';
export type ExitCode = 0 | 1 | 2;
export declare function getFallbackApisOrExit(argsApis: string[] | undefined, config: Config): Promise<Entrypoint[]>;
export declare function getAliasOrPath(config: Config, aliasOrPath: string): Entrypoint;
...
export declare function sortTopLevelKeys(document: Oas3Definition | Oas2Definition | Async2Definition | Async3Definition): Oas3Definition | Oas2Definition | Async2Definition | Async3Definition;
