...
const (
	...
	PaymentMethod_PAYMENT_METHOD_SBR PaymentMethod = 2
	// Кредитная карта
	PaymentMethod_PAYMENT_METHOD_CREDIT_CARD PaymentMethod = 3
	// Деньги инвестора (внутренний методы)
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x12PAYMENT_METHOD_SBR\x10\x02\x12\x1e\n" +
	"\x1aPAYMENT_METHOD_CREDIT_CARD\x10\x03\x12!\n" +
	"\x1dPAYMENT_METHOD_INVESTOR_MONEY\x10\x042W\n" +
	"\x0ePaymentService\x12E\n" +
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBHZFgithub.com/ownxrflxr/OnlineShop/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
