...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04part\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x04part\"E\n" +
	...
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\x9a\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\x03Get\x12\x18.inventory.v1.GetRequest\x1a\x19.inventory.v1.GetResponse\x12L\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBLZJgithub.com/ownxrflxr/OnlineShop/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*GetRequest)(nil),            // 4: inventory.v1.GetRequest
	(*GetResponse)(nil),           // 5: inventory.v1.GetResponse
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	6,  // 0: inventory.v1.ListPartsResponse.part:type_name -> inventory.v1.Part
	...
	6,  // 3: inventory.v1.GetResponse.part:type_name -> inventory.v1.Part
	...
	4,  // 11: inventory.v1.InventoryService.Get:input_type -> inventory.v1.GetRequest
	2,  // 12: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	5,  // 13: inventory.v1.InventoryService.Get:output_type -> inventory.v1.GetResponse
	1,  // 14: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
