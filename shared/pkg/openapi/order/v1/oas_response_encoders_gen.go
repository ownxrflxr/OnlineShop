...
func encodeCreateOrderByDetailsResponse(response CreateOrderByDetailsRes, w http.ResponseWriter, span trace.Span) error {
...
func encodeDeleteOrderByDetailsResponse(response DeleteOrderByDetailsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DeleteOrderByDetailsNoContent:
		w.WriteHeader(204)
